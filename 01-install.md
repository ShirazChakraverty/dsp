...
>> installed **Python 2** in order to keep it easier to follow along with bootcamp content.

###Q2. Which Python Version Installed   

How can you check the version of Python installed if you happen to be on an unfamiliar computer?

>> Just type _python_ on command line and the shell responds with the version.
